...
export function MainMenu({ actions }: MainMenuProps) {
  return (
    <>
      ...
      <span className="text-headline-lg font-headline-lg text-primary font-bold">942,050</span>
      <span className="text-label-mono font-label-mono text-secondary text-[10px]">LVL 42 PRESTIGE</span>
      </div>
